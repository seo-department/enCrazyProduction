...
export class SportsBettingCasinoReviewComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.metaTitle.setTitle('SportsBetting Casino Review 2025 - crazy vegas Casino');
    this.metaService.addTags([
      {name: 'description', content: 'Honest SportsBetting review. Sign up to claim your $1,500 welcome bonus | SportsBetting Casino Review 2025 - crazy vegas Casino'},
