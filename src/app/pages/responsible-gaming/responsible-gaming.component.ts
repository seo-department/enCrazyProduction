...
export class ResponsibleGamingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaService.addTags([
      {name: 'description', content: 'Responsible gambling should be a #1 priority of every online casino player. Our recommended online casinos are regulated and controlled by recognised third parties for responsible gaming.'},
