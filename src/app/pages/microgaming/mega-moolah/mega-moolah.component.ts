...
export class MegaMoolahComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaService.addTags([
      {name: 'description', content: 'Mega Moolah slot review 2023. Play the most popular progressive slot game online. Enjoy an exciting gameplay with great bonuses & MEGA payouts worth millions!'},
