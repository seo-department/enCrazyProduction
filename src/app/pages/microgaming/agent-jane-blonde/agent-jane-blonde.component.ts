...
export class AgentJaneBlondeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaService.addTags([
      {name: 'description', content: 'Agent Jane Blonde. A Microgaming slot where secret agent Jane Blonde acts as the game’s wild symbol. She can substitute for all symbols on the reels, but not the scatter.'},
