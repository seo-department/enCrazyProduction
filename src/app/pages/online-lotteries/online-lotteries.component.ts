...
export class OnlineLotteriesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaService.addTags([
      {name: 'description', content: 'Play the best online lotteries and stand to win big cash prizes. Buy lottery tickets online to win the biggest progressive pots of cash in 2024.'},
